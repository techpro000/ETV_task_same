...
//
//public class PlayTaskParsenerBack {
//
...
//    }
//
//    public PlayTaskParsenerBack(Activity context, PlayTaskView playTaskView) {
...
//     * 打印标签
//     */
//    private void getPmFromTask(int position, String printTag) {
...
//                        return;
//                    }
//                    generatorView = TaskDealUtil.getVideoPlayView(context, cpEntity, leftPosition, topPosition, width, height, videoList, AppInfo.PROGRAM_POSITION_MAIN);
...
//                    generatorView = new ViewImgMixSameGenerate(context, currentScentity, leftPosition, topPosition, width, height, mixtureList, true, 0, AppInfo.PROGRAM_POSITION_MAIN);
//                    addViewToList(generatorView, coType, false);
//                    view_abous.addView(generatorView.getView(), generatorView.getLayoutParams());
//                    break;
//            }
...
//                viewImgMixSameGenerate.clearMemory();
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//        List<File> listFilelocal = listFileSearch;
//        for (int i = 0; i < listEntities.size(); i++) {
//            for (int j = 0; j < listFileSearch.size(); j++) {
//                String webFileUrl = listEntities.get(i).getUrl();
//                String webFileName = webFileUrl.substring(webFileUrl.lastIndexOf(" / ") + 1);
//                String fileLocalName = listFileSearch.get(j).getName();
//                if (webFileName.contains(fileLocalName)) {
//                    listFilelocal.remove(j);
//                }
//            }
//        }
...
//    }
//
//    public void updateSameTaskVideoProgress(SameTaskVideo sameTaskVideo) {
...
//            return;
//        }
//        String senIdReceive = sameTaskVideo.getSecenId();
...
//            //播放时同一个视频，这里去同步进度
//            MyLog.udp("=======播放逻辑开始同步进度====");
//            if (viewImgMixSameGenerate == null) {
//                viewImgMixSameGenerate = new ViewImgMixSameGenerate(context, null, 0, 0,
//                        screenWidth, screenHeight, mediAddEntityList, true, 0, AppInfo.PROGRAM_POSITION_MAIN);
//                view_abous.addView(viewImgMixSameGenerate.getView(), viewImgMixSameGenerate.getLayoutParams());
//                viewImgMixSameGenerate.updateView(null, true);
//            }
...
//    /****
//     * 同步模式 开始同步主屏得任务
//     * @param startUploadEntity
//     */
//    public void startToUploadMainScreenProgram(StartUploadEntity startUploadEntity) {
//        if (startUploadEntity == null) {
//            return;
//        }
//        MyLog.udp("Parsener 接收到播放指令===" + startUploadEntity.toString());
////        if (!ifSameTaskModel) {
////            MyLog.udp("不是同步模式，拦截");
////            return;
////        }
...
////        MediAddEntity mediAddEntity = new MediAddEntity(startUploadEntity.getFilePath(), "-1", "1", startUploadEntity.getPlayParam(), "70",
////                startUploadEntity.getFileType(), AppInfo.PROGRAM_DEFAULT, 0);
...
////            return;
////        }
////        viewImgMixSameGenerate.updateTextInfo(mediAddEntity);
//    }
//
//
//    /***
...
//     */
//    String lastTaskId = "";  //缓存上一步得任务
//
//    private void parsenerSameTaskFromDb(TaskWorkEntity taskWorkSameEntity) {
//        if (taskWorkSameEntity == null) {
//            playTaskView.showViewError("检测同步任务异常，请检查");
//            return;
//        }
//        String taskType = taskWorkSameEntity.getEtTaskType();
//        if (!taskType.equals(AppInfo.TASK_TYPE_DOUBLE)) {
//            //单个屏幕播放节奏
//            startToPlaySingleScreenProgram(taskWorkSameEntity);
//            return;
//        }
//        List<SceneEntity> sceneEntityListCache = new ArrayList<>();
//        List<SceneEntity> listCacheSenc = DbTaskManager.getSencenEntityFormDbByTask(taskWorkSameEntity);
//        if (listCacheSenc != null && listCacheSenc.size() > 0) {
//            sceneEntityListCache.addAll(listCacheSenc);
//        }
//        if (sceneEntityListCache == null || sceneEntityListCache.size() < 1) {
...
//     * @param taskWorkSameEntity
//     */
//    private void startToPlaySingleScreenProgram(TaskWorkEntity taskWorkSameEntity) {
//        MyLog.playTask("====同步任务======检测到有同步模式我任务====");
//        String taskId = taskWorkSameEntity.getTaskId();
//        if (taskId.equals(lastTaskId)) {
//            MyLog.playTask("====同步任务======任务没有变化，不刷新界面====");
//            return;
//        }
//        List<MpListEntity> mpListEntityList = DBTaskUtil.getMpListByTaskId(taskId);
//        if (mpListEntityList == null || mpListEntityList.size() < 1) {
//            MyLog.playTask("=====同步任务=====mpListEntityList==null====");
//            return;
//        }
//        MyLog.playTask("=====同步任务=====mpListEntityList======" + mpListEntityList.size());
//        List<MediAddEntity> mediAddEntityList = TaskDealUtil.getResourceListPath(mpListEntityList);
//        if (!isSameTaskLeader) {
//            return;
//        }
//        //Leader  加载所有得素材信息
//        ViewImgMixSameGenerate generatorView = new ViewImgMixSameGenerate(context, null, 0, 0, screenWidth, screenHeight, mediAddEntityList,
//                true, 0, AppInfo.PROGRAM_POSITION_MAIN);
//        addViewToList(generatorView, AppInfo.VIEW_IMAGE_VIDEO, false);
//        view_abous.addView(generatorView.getView(), generatorView.getLayoutParams());
//        generatorView.updateView(null, true);
//        lastTaskId = taskId;
//    }
