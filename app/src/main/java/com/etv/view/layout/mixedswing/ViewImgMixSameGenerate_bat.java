...
// * 按照顺序来播放
// */
//public class ViewImgMixSameGenerate_bat extends Generator {
//
//    View view;
...
//    int playPosition = 0;
//
//    public ViewImgMixSameGenerate_bat(Activity context, SceneEntity currentScentity, int x, int y,
...
//        boolean mainLeader = SharedPerUtil.getSameTaskMainLeader();
//        MyLog.udp("==sendStartToUploadPram=发送开始播放消息,tag==" + tag);
//        if (!mainLeader) { //不是主关系
...
//
//        String sendMessage = Command.buildPlayCmd(fileType, playParam, filePath, secenId, 0);
...
//
//
//    private boolean startSendProgress = false;
//
...
//            return;
//        }
//        startSendProgress = true;
//        new Thread() {
//            @Override
//            public void run() {
//                while (startSendProgress) {
//                    try {
//                        Thread.sleep(1000);
...
//     * @param sameTaskVideo
//     */
//    public void updateVideoPlayProgress(SameTaskVideo sameTaskVideo) {
//        if (sameTaskVideo == null) {
//            MyLog.playMix("====updateVideoPlayProgress==sameTaskVideo==null==");
//            return;
//        }
//        if (generatorView == null || !(generatorView instanceof ViewUdpViewNewGenertrator)) {
//            MyLog.playMix("====updateVideoPlayProgress==generatorView==null==");
//            return;
//        }
//        MyLog.playMix("====updateVideoPlayProgress==classname==" + sameTaskVideo.getProgress());
